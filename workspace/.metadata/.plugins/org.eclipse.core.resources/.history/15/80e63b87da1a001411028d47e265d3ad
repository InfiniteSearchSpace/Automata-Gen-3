	...
	public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() { 
            ...
            public void run() { //breaks program's static dependance
            	...
            	int xSize = 200/*3*2* 28 +1*/; //size of each surface
            	int ySize = 200/*3*2* 28 +1*/;
            	int zSize = 16;
            	...
            	a[0] = new automataLib(m,xSize,ySize);	
            	...
            	sl[0] = new slider(m,xSize,yysize,zSize, myml, 0, 5);
            	sl[1] = new slider(m,xSize,yysize,zSize, myml, 1, 25);
